...
public class GenSubject extends AppCompatActivity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_gen_subject);
        ...
        final ViewPager2 viewPager2 = findViewById(R.id.GenSubjectViewPager);
        viewPager2.setAdapter(new ViewAdapter(this,fragments));

        final TabLayout tabLayout = findViewById(R.id.GenSubjectButtonView);
